...
class XaccGenerator:
    ...
    def generate_python_script(self):
        ...
        self.print("from puc8a.ppci.lang.tools.grammar import Production, Grammar")
        self.print(
            "from puc8a.ppci.lang.tools.lr import LrParser, Reduce, Shift, Accept"
        )
        self.print("from puc8a.ppci.lang.common import Token")
        self.print("")
